...
export default function Comment_component() {
  ...
  return (
    <div>
        {/* form */}
      <form className="flex items-center w-full gap-x-2 my-4">
        <img
          src={
        ...
        <div
          ...
          } flex items-centerflex items-center w-full rounded py-1 px-2`}
        >
          <input className='w-full p-2 rounded opacity-80 outline-none'/>
